...
(define (domain RCLLV2)
; C0-C3, no ring costs, no colors
...
(:durative-action addRingToWorkpiece
    :parameters (?rs - ringStation ?wp - workpiece ?r - ring)
...
(:durative-action addCapToWorkpiece
    :parameters (?cs - capStation ?wp - workpiece ?c - Cap) 

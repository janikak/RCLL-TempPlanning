...
(define (domain RCLLV2_colors)
; C0-C3, no ring costs, colors
...
(:constants 
    ...
    blue - workpieceColor		    ;ring
    green - workpieceColor		    ;ring
    yellow - workpieceColor		    ;ring
    orange - workpieceColor	        ;ring
